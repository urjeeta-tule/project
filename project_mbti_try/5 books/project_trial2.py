...
# @app.route('/')
# def hello_world():
# 	header = 'Hello, World!<br>This is Personality Detector<br>'
...
# 		personality_type = testit(text,clf)

# 		Output = "The author of given text has <b>"+str(personality_type)+" %</b> Myers Briggs personality type"
...
def generate_dataset():
	...
	with open("finaldataset.csv", "r") as infile:
		for line in infile:
...
def generate_word2vec_model(dataset):
	...
	# i = int(0.6*len(processed_sentences_list))
	...
	# l = []
	# for sentence in processed_sentences_list[i:]:
	...
	print "Total number of words :",xount
...
def cross_eval(word2vec_model,dataset):
	...
	clf = MLPClassifier(solver='sgd', alpha=1e-3, hidden_layer_sizes=(800, 400, 200, 100), random_state=1, max_iter=5000)
